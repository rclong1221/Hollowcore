...
namespace Opsive.UltimateCharacterController.SurfaceSystem
{
    ...
    public class SurfaceManager : MonoBehaviour
    {
        ...
        private static SurfaceManager Instance
        {
            get
            {
                if (!s_Initialized) {
                    ...
                    s_Instance = UnityEngine.Object.FindAnyObjectByType<SurfaceManager>();
#else
                    s_Instance = UnityEngine.Object.FindObjectOfType<SurfaceManager>();
#endif
                    if (s_Instance == null) {
        ...
        public string MainTexturePropertyName { get { return m_MainTexturePropertyName; } set { m_MainTexturePropertyName = value; } }
        ...
        private bool HasComplexMaterial(Collider hitCollider)
        {
            ...
            if (!m_ColliderComplexMaterialsMap.TryGetValue(hitCollider, out var complexMaterials)) {
                ...
                if (hitRenderer != null) {
                    ...
                    if (mesh != null) {
                        complexMaterials = mesh.subMeshCount > 1;
                    }
                }
        ...
        private Texture GetTerrainTexture(Vector3 worldPosition, Terrain terrain)
        {
            ...
            if (terrain.terrainData.terrainLayers == null || terrainTextureID > terrain.terrainData.terrainLayers.Length - 1 ||
                terrain.terrainData.terrainLayers[terrainTextureID] == null) {
                return null;
            }
