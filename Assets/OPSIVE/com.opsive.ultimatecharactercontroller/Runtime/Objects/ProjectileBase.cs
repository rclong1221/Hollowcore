...
namespace Opsive.UltimateCharacterController.Objects
{
    ...
    public abstract class ProjectileBase : TrajectoryObject
    {
        ...
        [Tooltip("If true the ImpactLayer and SurfaceLayer won't be overwritten by the impact damage data.")]
        [SerializeField] protected bool m_UseObjectImpactLayerAndSurface;
        ...
        public bool UseObjectImpactLayerAndSurface { get { return m_UseObjectImpactLayerAndSurface; } set { m_UseObjectImpactLayerAndSurface = value; } }
        ...
        /// <param name="useObjectImpactLayerAndSurface">Should the Impact Layer and Surface impact be kept from the prefab?</param>
