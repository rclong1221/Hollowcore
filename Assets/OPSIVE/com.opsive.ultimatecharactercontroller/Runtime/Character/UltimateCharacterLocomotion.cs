...
namespace Opsive.UltimateCharacterController.Character
{
    ...
    public class UltimateCharacterLocomotion : CharacterLocomotion, Shared.Character.ICharacter
    {
        ...
        [SerializeReference] [IgnoreReferences] protected Ability[] m_Abilities;
        [Tooltip("A reference to the Item Abilities that provide extra item functionality.")]
        [SerializeReference] [IgnoreReferences] protected ItemAbility[] m_ItemAbilities;
        [Tooltip("A reference to the Effects that provide extra functionality.")]
        [SerializeReference] [IgnoreReferences] protected Effect[] m_Effects;
        ...
        public virtual MovementType[] MovementTypes
        {
        ...
        public virtual ItemAbility[] ItemAbilities
        {
        ...
        protected Vector3 m_MaxHeightPosition;
        ...
        [Shared.Utility.NonSerialized] public bool FirstPersonPerspective { get => m_FirstPersonPerspective; set => m_FirstPersonPerspective = value; }
        ...
        public override float TimeScale
        {
            ...
            set {
                ...
                if (Application.isPlaying && base.TimeScale != value) {
        ...
        [Shared.Utility.NonSerialized] public Vector3 MaxHeightPosition { get => m_MaxHeightPosition; set => m_MaxHeightPosition = value; }
        ...
        public void SetMovementType(string typeName)
        {
        ...
        protected void UpdateAbilities(Ability[] abilities)
        {
            ...
            for (int i = 0; i < abilities.Length; ++i) {
                ...
                if (!ability.IsActive) {
                    if (ability.StartType == Ability.AbilityStartType.Automatic) {
                        TryStartAbility(ability);
                    } else if (ability.StartType != Ability.AbilityStartType.Manual && ability.CheckForAbilityMessage &&
                        ...
                        ability.AbilityMessageCanStart = ability.Enabled && ability.CanStartAbility();
                    }
                } else if (ability.IsActive && ability.StopType == Ability.AbilityStopType.Automatic) {
        ...
        /// <summary>
        /// Calls Update the active effects.
        /// </summary>
        protected virtual void UpdateActiveEffects()
        {
            if (m_ActiveEffects != null) {
        ...
        /// </summary>
        protected virtual void LateUpdateActiveAbilities()
        {
            if (m_ActiveAbilities != null) {
                for (int i = 0; i < m_ActiveAbilityCount; ++i) {
                    m_ActiveAbilities[i].LateUpdate();
                }
            }
            if (m_ActiveItemAbilities != null) {
                for (int i = 0; i < m_ActiveItemAbilityCount; ++i) {
                    m_ActiveItemAbilities[i].LateUpdate();
                }
            }
        }
        ...
        protected override void UpdateRotation()
        {
            ...
            UpdateRotationActiveAbilities();
        }

        /// <summary>
        /// Calls UpdateRotation on the active abilities.
        /// </summary>
        protected virtual void UpdateRotationActiveAbilities()
        {
            for (int i = 0; i < m_ActiveAbilityCount; ++i) {
        ...
        {
            ApplyRotationActiveAbilities();

            base.ApplyRotation();
        }

        /// <summary>
        /// Calls ApplyRotation on the active abilities.
        /// </summary>
        protected virtual void ApplyRotationActiveAbilities()
        {
            for (int i = 0; i < m_ActiveAbilityCount; ++i) {
        ...
        protected override void UpdatePosition()
        {
            ...
            UpdatePositionActiveAbilities();
        }

        /// <summary>
        /// Calls UpdatePosition on the active abilities.
        /// </summary>
        protected virtual void UpdatePositionActiveAbilities()
        {
            for (int i = 0; i < m_ActiveAbilityCount; ++i) {
        ...
        {
            ApplyPositionActiveAbilities();

            base.ApplyPosition();
        }

        /// <summary>
        /// Calls ApplyPosition on the active abilities.
        /// </summary>
        protected virtual void ApplyPositionActiveAbilities()
        {
            for (int i = 0; i < m_ActiveAbilityCount; ++i) {
        ...
        protected override void UpdateDesiredMovement()
        {
            ...
            UpdateDesiredMovementActiveAbilities();
        }

        /// <summary>
        /// Calls UpdateDesiredMovement on the active abilities.
        /// </summary>
        protected virtual void UpdateDesiredMovementActiveAbilities()
        {
            for (int i = 0; i < m_ActiveAbilityCount; ++i) {
        ...
        public bool TryStartAbility(Ability ability, bool ignorePriority = false, bool ignoreCanStartCheck = false)
        {
            ...
            if ((!ability.IsActive || ability.CanReceiveMultipleStarts) && ability.Enabled && (ignoreCanStartCheck || ability.CanStartAbility())) {
                ...
                if (!ability.IsActive) {
                    ...
                    if (!(ability is ItemEquipVerifier) && m_ItemEquipVerifierAbility != null) {
                        ...
                        if (m_ItemEquipVerifierAbility.TryToggleItem(ability, true) && !ability.ImmediateStartItemVerifier) {
                            moveEquipStarted = moveEquipStarted || m_ItemEquipVerifierAbility.IsActive;
                        }
                    }
                ...
                // Execute the event before the ability is started in case the ability is stopped within Ability.AbilityStarted.
        ...
        public void StopAllAbilities(bool fromDeath)
        {
            for (int i = m_ActiveAbilityCount - 1; i >= 0; --i) {
        ...
        public virtual void SetRotation(Quaternion rotation, bool snapAnimator = true)
        {
        ...
        /// <param name="snapAnimator">Should the animator be snapped into position?</param>
        public virtual void SetPosition(Vector3 position, bool snapAnimator = true)
        {
            // If the character isn't active then only the transform needs to be set.
            if (m_GameObject == null) {
        ...
        public virtual void SetPositionAndRotation(Vector3 position, Quaternion rotation, bool snapAnimator, bool stopAllAbilities
#if ULTIMATE_CHARACTER_CONTROLLER_MULTIPLAYER
        ...
        private void OnDrawGizmos()
        {
            if (m_Abilities != null) {
                for (int i = 0; i < m_Abilities.Length; ++i) {
                    if (m_Abilities[i] == null) { continue; }
                    m_Abilities[i].OnDrawGizmos();
                }
            }
            if (m_ItemAbilities != null) {
                for (int i = 0; i < m_ItemAbilities.Length; ++i) {
                    if (m_ItemAbilities[i] == null) { continue; }
