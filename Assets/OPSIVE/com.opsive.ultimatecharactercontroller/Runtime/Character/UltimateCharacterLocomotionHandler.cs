...
namespace Opsive.UltimateCharacterController.Character
{
    ...
    public class UltimateCharacterLocomotionHandler : CharacterHandler
    {
        ...
        protected List<ActiveInputEvent> m_ActiveInputList;
        protected bool m_InputEnabled;
        protected Vector2 m_LookVector;

        protected bool m_OverrideInput;
        protected float m_OverriddenHorizontalMovement;
        protected float m_OverriddenForwardMovement;
        protected Vector2 m_OverriddenLookVector;
        ...
        /// </summary>
        protected virtual void UpdateAbilityInput(Ability[] abilities)
        {
            if (abilities != null) {
        ...
        protected virtual void CheckAbilityInput(Ability[] abilities)
        {
            for (int i = 0; i < abilities.Length; ++i) {
                if (abilities[i].IsActive) {
                    continue;
        ...
        public virtual void UnregisterInputEvent(ActiveInputEvent inputEvent)
        {
