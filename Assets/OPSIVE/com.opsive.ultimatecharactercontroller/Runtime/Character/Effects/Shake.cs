...
namespace Opsive.UltimateCharacterController.Character.Effects
{
    ...
    public class Shake : Effect
    {
        ...
        [SerializeField] protected ShakeTarget m_Target = ShakeTarget.Camera | ShakeTarget.Item | ShakeTarget.Character;
        ...
        public override void Update()
        {
            ...
            if (m_SmoothHorizontalForce) {
                ...
                force.x = SmoothRandom.GetVector3Centered(1).x * m_Force.x * Mathf.Min(endTime - Time.unscaledTime, m_FadeOutDuration) * TimeUtility.TimeScale * m_CharacterLocomotion.TimeScale;
            } else {
