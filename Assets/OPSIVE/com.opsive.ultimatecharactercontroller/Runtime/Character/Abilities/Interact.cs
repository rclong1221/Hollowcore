...
using Opsive.Shared.Networking;
    ...
    public class Interact : DetectObjectAbilityBase
    {
        ...
        [Tooltip("Can the Aim ability stay active while interacting?")]
        [SerializeField] protected bool m_AllowAim;
        [Tooltip("Can the Interact ability run at the same time as other abilities?")]
        [SerializeField] protected bool m_Concurrent;
        ...
        public bool AllowAim { get { return m_AllowAim; } set { m_AllowAim = value; } }
        public bool Concurrent { get { return m_Concurrent; } set { m_Concurrent = value; } }
        public int AbilityIntDataValue { get { return m_AbilityIntDataValue; } set { m_AbilityIntDataValue = value; if (IsActive) { UpdateAbilityAnimatorParameters(); } } }
        public AnimationEventTrigger InteractEvent { get { return m_InteractEvent; } set { m_InteractEvent.CopyFrom(value); } }
        public AnimationEventTrigger InteractCompleteEvent { get { return m_InteractCompleteEvent; } set { m_InteractCompleteEvent.CopyFrom(value); } }
        ...
        public override bool IsConcurrent { get { return m_Concurrent; } }
        ...
        public override void Awake()
        {
            ...
            m_InteractEvent.RegisterUnregisterAnimationEvent(true, m_GameObject, "OnAnimatorInteract", DoInteract);
        ...
        public override bool CanStartAbility()
        {
            ...
            if (m_Interactable == null || !m_Interactable.CanInteract(m_GameObject, this)) {
                return false;
            }
        ...
        {
            return (!m_AllowActiveHeightChange && activeAbility is HeightChange) || activeAbility is StoredInputAbilityBase || (!m_AllowAim && activeAbility is Items.Aim);
        }
        ...
        {
            m_InteractEvent.CancelWaitForEvent();
            ...
            m_Interactable.Interact(m_GameObject, this);
        ...
        {
            m_InteractCompleteEvent.CancelWaitForEvent();
        ...
        public override void OnDestroy()
        {
            ...
            m_InteractEvent.RegisterUnregisterAnimationEvent(false, m_GameObject, "OnAnimatorInteract", DoInteract);
            m_InteractCompleteEvent.RegisterUnregisterAnimationEvent(false, m_GameObject, "OnAnimatorInteractComplete", InteractComplete);
        }
    }
}