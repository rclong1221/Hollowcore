...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class Slide : Ability
    {
        ...
        public override void UpdatePosition()
        {
            ...
            m_SlideSpeed /= (1 + m_SlideDamping * m_CharacterLocomotion.TimeScale * TimeUtility.TimeScale);
            ...
            if (m_SlideSpeed > 0) {
                ...
                m_CharacterLocomotion.DesiredMovement += m_SlideSpeed * m_CharacterLocomotion.TimeScale * TimeUtility.TimeScale * m_SlideDirection;
        ...
        protected override void AbilityStopped(bool force)
        {
            ...
            if (m_SlideSpeed > 0) {
                AddForce((m_SlideSpeed / TimeUtility.DeltaTime) * m_CharacterLocomotion.TimeScale * TimeUtility.TimeScale * m_SlideDirection, 1, false);
            }
