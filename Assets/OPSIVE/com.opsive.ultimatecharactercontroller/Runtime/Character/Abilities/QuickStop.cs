...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class QuickStop : StoredInputAbilityBase
    {
        ...
        protected override bool UseRawInput { get { return m_AIAgent; } }
        ...
        public override void Awake()
        {
            ...
            m_AIAgent = (m_CharacterLocomotion.LookSource) is LocalLookSource;
        ...
        {
            m_AIAgent = lookSource is LocalLookSource;
        }
        ...
        public override bool CanStartAbility()
        {
            ...
            var input = m_AIAgent ? m_CharacterLocomotion.InputVector : m_CharacterLocomotion.RawInputVector;
            if (Mathf.Abs(input.x) > Mathf.Abs(m_Inputs[m_InputsIndex].x) ||
                Mathf.Abs(input.y) > Mathf.Abs(m_Inputs[m_InputsIndex].y)) {
                return false;
            }
        ...
        {
            return m_EventStop || (m_AIAgent ? m_CharacterLocomotion.InputVector : m_CharacterLocomotion.RawInputVector).sqrMagnitude > 0.001f;
        }
