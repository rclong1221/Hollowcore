...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class RestrictRotation : Ability
    {
        ...
        {
            var targetRotation = m_CharacterLocomotion.TargetRotation;
            ...
            if (m_RotationSmoothing) {
                targetRotation = Quaternion.Slerp(m_CharacterLocomotion.Rotation, targetRotation, m_CharacterLocomotion.MotorRotationSpeed * TimeUtility.DeltaTime);
            }
            m_CharacterLocomotion.DesiredRotation = targetRotation * Quaternion.Inverse(m_CharacterLocomotion.Rotation);
        }
