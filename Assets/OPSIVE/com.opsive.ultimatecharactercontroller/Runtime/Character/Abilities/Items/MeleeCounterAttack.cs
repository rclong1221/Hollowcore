...
namespace Opsive.UltimateCharacterController.Character.Abilities.Items
{
    ...
    public class MeleeCounterAttack : Use
    {
        ...
        private int m_OpponentItemSubstateIndex;
        ...
        public override bool CanStartAbility()
        {
            ...
            if (m_ImpactTime == -1 || m_ImpactTime + m_CounterAttackTimeFrame < TimeUtility.Time) {
                return false;
            }
        ...
        public override int GetItemSubstateIndex(int slotID)
        {
            ...
            var opponentItemSubstateIndex = m_OpponentMeleeWeapon.GetUseItemSubstateIndex();
            // The substate index needs to be positive to prevent concatentation errors.
            if (opponentItemSubstateIndex > 0) {
                m_OpponentItemSubstateIndex = opponentItemSubstateIndex;
            }
            var concatenate = MathUtility.Concatenate(animatorItemID, m_OpponentItemSubstateIndex, substateIndex);
            return concatenate;
        }
