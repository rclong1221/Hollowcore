...
namespace Opsive.UltimateCharacterController.Character.Abilities.Items
{
    ...
    public class EquipUnequip : ItemSetAbilityBase
    {
        ...
        [System.NonSerialized] private EquipUnequip[] m_EquipUnequipAbilities;
        ...
        private void OnRemoveItem(CharacterItem characterItem, int slotID)
        {
            ...
            var activeItemSet = m_ItemSetManager.GetItemSet(m_ActiveItemSetIndex, m_ItemSetGroupIndex);
            if (m_ActiveItemSetIndex == -1 || activeItemSet == null || activeItemSet.ItemIdentifiers.Contains(characterItem.ItemIdentifier) == false) {
                return;
            }

            var prevImmediateEquipUnequip = m_ImmediateEquipUnequip;
            var nextItemSetIndex = m_ItemSetManager.FindClosestMatchingValidItemSet(m_ItemSetGroupIndex, m_ActiveItemSetIndex, true, false);
            ...
            StartEquipUnequip(nextItemSetIndex, true, true);
