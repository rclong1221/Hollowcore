...
namespace Opsive.UltimateCharacterController.Character.Abilities.Items
{
    ...
    public class Reload : ItemAbility
    {
        ...
        public enum AutoReloadType
        {
            ...
            Equip = 4,  // Automatically reload when the item is equipped.
        }
        ...
        public override bool ShouldBlockAbilityStart(Ability startingAbility)
        {
            ...
            var equipUnequip = startingAbility as EquipUnequip;
            if (equipUnequip != null) {
                if (!equipUnequip.PreventStartUseReloadActive) {
                    for (int i = 0; i < m_ReloadableItems.Length; ++i) {
                        StopItemReload(i);
                    }
                    return false;
        ...
        {
            // The method may be called from an animation event when the ability isn't active.
            if (!IsActive) {
                return;
            }
