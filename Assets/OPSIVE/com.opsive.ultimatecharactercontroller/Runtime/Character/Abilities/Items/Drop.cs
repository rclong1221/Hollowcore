    ...
    public class Drop : ItemAbility
    {
        ...
        private void DropItem()
        {
            ...
            for (int i = 0; i < m_Items.Length; ++i) {
                ...
                // UnequipItem may not occur if the unequip events don't trigger immediately.
                if (m_Inventory.GetActiveCharacterItem(item.SlotID) == item) {
                    m_Inventory.UnequipItem(item.SlotID);
                }
                if (droppedItem != null) {
