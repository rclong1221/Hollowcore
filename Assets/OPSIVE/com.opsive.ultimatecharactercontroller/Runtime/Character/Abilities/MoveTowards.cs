...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class MoveTowards : Ability
    {
        ...
        private SpeedChange m_ActiveSpeedChange;
            ...
            if (m_Arrived && (m_CharacterLocomotion.ItemEquipVerifierAbility == null || !m_CharacterLocomotion.ItemEquipVerifierAbility.IsActive)) {
                if (!m_MoveTowardsLocation.PrecisionStart || Time.frameCount > m_PrecisionStartWaitFrame + 1) {
                    ...
                    if (m_MoveTowardsLocation.PrecisionStart &&
                        (m_AnimationMonitor != null && (m_AnimationMonitor.IsInTransition(0) || m_CharacterLocomotion.Moving))) {
        ...
        protected virtual Vector2 GetInputVector(Vector3 direction)
        {
            ...
            return m_InputMultiplier * m_MoveTowardsLocation.MovementMultiplier * (m_ActiveSpeedChange != null ? m_ActiveSpeedChange.SpeedChangeMultiplier : 1) * inputVector.normalized;
        }
        ...
        public override void ApplyRotation()
        {
            ...
            m_CharacterLocomotion.DesiredRotation = Quaternion.RotateTowards(Quaternion.identity, Quaternion.Euler(rotation), m_CharacterLocomotion.MotorRotationSpeed * m_CharacterLocomotion.TimeScale * TimeUtility.TimeScale);
        }
        ...
        {
            if (ability is not SpeedChange) {
                return;
            }

            m_ActiveSpeedChange = active ? ability as SpeedChange : null;
        }
