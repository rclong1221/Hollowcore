...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class Ragdoll : Ability
    {
        ...
        [Layer] [SerializeField] protected int m_RagdollLayer = LayerManager.Character;
        ...
        private void EnableRagdoll(bool enable, Vector3 force, Vector3 position)
        {
            ...
            if (m_AnimationMonitor != null) {
                m_AnimationMonitor.EnableAnimator(!enable);
            }
            if (enable) {
