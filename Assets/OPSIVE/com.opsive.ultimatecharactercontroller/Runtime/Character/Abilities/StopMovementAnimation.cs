...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class StopMovementAnimation : Ability
    {
        ...
        {
            if (m_CharacterLocomotion.InputVector.sqrMagnitude < m_CharacterLocomotion.ColliderSpacing) {
                return false;
            }
            ...
            if (m_CharacterLocomotion.SingleCast(direction, Vector3.zero, direction.magnitude, m_CharacterLayerManager.SolidObjectLayers, ref m_RaycastHit)) {
                ...
                // The character may be able to step over the object.
                var groundPoint = MathUtility.InverseTransformPoint(m_CharacterLocomotion.Position, m_CharacterLocomotion.Rotation, m_RaycastHit.point - m_CharacterLocomotion.MovingPlatformMovement);
                if (groundPoint.y <= m_CharacterLocomotion.MaxStepHeight && groundPoint.y > 0) {
                    return false;
                }
        ...
        public override void ApplyPosition()
        {
            ...
            localDesiredMovement.x = localDesiredMovement.z = 0;
