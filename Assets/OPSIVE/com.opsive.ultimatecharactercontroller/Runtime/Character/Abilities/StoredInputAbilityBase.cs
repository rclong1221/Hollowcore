...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public abstract class StoredInputAbilityBase : Ability
    {
        ...
        public override void InactiveUpdate()
        {
            ...
            m_InputsIndex = (m_InputsIndex + 1) % m_MaxInputCount;
            m_Inputs[m_InputsIndex] = UseRawInput ? m_CharacterLocomotion.RawInputVector : m_CharacterLocomotion.InputVector;
            // The count will increase until the max value count.
            if (m_InputsIndex == m_InputCount) {
                m_InputCount++;
            }
        }
