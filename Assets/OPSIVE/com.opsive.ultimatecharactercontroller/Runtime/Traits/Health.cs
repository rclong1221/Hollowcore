...
namespace Opsive.UltimateCharacterController.Traits
{
    ...
    public class Health : StateBehavior, IDamageTarget
    {
...
#endif
        protected Attribute m_HealthAttribute;
        protected Attribute m_ShieldAttribute;
        ...
        public float HealthValue { get { return (m_HealthAttribute != null ? m_HealthAttribute.Value : 0); } set { if (m_HealthAttribute != null) { m_HealthAttribute.Value = value; } } }
        public float ShieldValue { get { return (m_ShieldAttribute != null ? m_ShieldAttribute.Value : 0); } set { if (m_ShieldAttribute != null) { m_ShieldAttribute.Value = value; } } }
        public float Value { get { return HealthValue + ShieldValue; } }
        public Attribute HealthAttribute { get { return m_HealthAttribute; } }
        public Attribute ShieldAttribute { get { return m_ShieldAttribute; } }
        ...
        public virtual void Damage(DamageData damageData)
        {
            ...
            if (m_Invincible || !IsAlive() || m_SpawnTime + m_TimeInvincibleAfterSpawn > TimeUtility.Time || damageData.Amount == 0) {
                return;
            }
        ...
        public virtual bool Heal(float amount)
        {
            ...
            if (m_DamagePopupMonitor != null) {
                m_DamagePopupMonitor.OpenHealPopup(m_Transform.position, healAmount);
            }
