...
namespace Opsive.UltimateCharacterController.Traits
{
    ...
    public class Attribute : StateObject
    {
        ...
        public void ScheduleAutoUpdate(float delay)
        {
            ...
            if ((m_AutoUpdateValueType == AutoUpdateValue.Increase && m_Value != m_MaxValue) ||
                ...
                // Do not use a 0 start time otherwise UpdateValue will be called immediately and the event will be scheduled twice.
                m_AutoUpdateEvent = Scheduler.Schedule(Mathf.Max(delay, 0.001f), UpdateValue);
            }
        }
        ...
        {
            if (m_AutoUpdateValueType == AutoUpdateValue.None || m_GameObject == null || (!m_UpdateWhenInactive && !m_GameObject.activeInHierarchy)) {
                return;
            }
    ...
    public class AttributeModifier
    {
        ...
        [System.NonSerialized] private Attribute m_Attribute;
