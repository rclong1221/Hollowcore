...
namespace Opsive.UltimateCharacterController.UI
{
    ...
    public class RepeatButton : Button
    {
        ...
        private void Update()
        {
            ...
            var time = TimeUtility.Time - m_FirstPressTime - m_InitialDelay;
            if (time < 0) { return; }
            ...
            if (TimeUtility.Time > period + m_LastPressTime) {
                Press();
            }
        }
        ...
        public override void OnPointerDown(PointerEventData eventData)
        {
            ...
            if (m_HoldingDown == false) {
                ...
                m_FirstPressTime = TimeUtility.Time;
                m_HoldingDown = true;
            }
        }
        ...
        public virtual void Press()
        {
            ...
            m_LastPressTime = TimeUtility.Time;
