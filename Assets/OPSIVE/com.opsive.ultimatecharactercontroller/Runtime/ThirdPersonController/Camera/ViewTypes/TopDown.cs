...
namespace Opsive.UltimateCharacterController.ThirdPersonController.Camera.ViewTypes
{
    ...
    public class TopDown : ViewType
	{
        ...
        public virtual Spring SecondaryPositionSpring
        {
        ...
        public virtual Spring SecondaryRotationSpring
        {
        ...
        public override void AttachCharacter(GameObject character)
        {
            ...
            if (m_Character != null) {
                ...
                m_LookDirection = m_CharacterLocomotion.Rotation * Vector3.forward;
        ...
        public override Quaternion Rotate(float horizontalMovement, float verticalMovement, bool immediateUpdate)
        {
            ...
            return (immediateUpdate ? rotation : Quaternion.Slerp(m_Transform.rotation, rotation, m_RotationSpeed * m_CharacterLocomotion.TimeScale * TimeUtility.TimeScale * TimeUtility.DeltaTime))
        ...
        public override Vector3 LookPosition(bool characterLookPosition)
        {
            ...
            return m_CharacterLocomotion.Position;
        }
        ...
        {
            m_CameraRotationLerp += m_CharacterLocomotion.TimeScale * TimeUtility.TimeScale * TimeUtility.DeltaTime * m_ChangeAngleSpeed * m_CameraRotateSpeedCorrection;
        ...
        {
            m_CameraPitchLerp += m_CharacterLocomotion.TimeScale * TimeUtility.TimeScale * TimeUtility.DeltaTime * m_ChangePitchSpeed * m_CameraPitchSpeedCorrection;
        ...
        {
            m_CameraDistanceLerp += m_CharacterLocomotion.TimeScale * TimeUtility.TimeScale * TimeUtility.DeltaTime * m_ChangeDistanceSpeed;
