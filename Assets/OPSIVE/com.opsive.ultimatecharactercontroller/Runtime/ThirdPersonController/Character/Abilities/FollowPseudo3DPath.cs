    ...
    public class FollowPseudo3DPath : Ability
    {
        ...
        public override void UpdatePosition()
        {
            ...
            if (m_Pseudo3DMovementType.AllowDepthMovement && m_CharacterLocomotion.RawInputVector.y != 0) {
                m_Offset -= MathUtility.InverseTransformDirection(m_CharacterLocomotion.DesiredMovement, pathRotation).x;
            }
            ...
            m_CharacterLocomotion.DesiredMovement = targetPosition - m_Transform.position;
        }
