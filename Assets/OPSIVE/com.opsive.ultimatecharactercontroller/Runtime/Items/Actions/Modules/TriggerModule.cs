...
namespace Opsive.UltimateCharacterController.Items.Actions.Modules
{
    ...
    public abstract class SimpleBaseTrigger : TriggerModuleAnimatorAudioStateSet, IModuleReloadItem
    {
        ...
        protected virtual bool ForceTrigger { get => false; }
        ...
        {
            var index = -1;
            if (m_IsTriggering || ForceTrigger) {
            ...
            streamData.TryAddSubstateData(this, new ItemSubstateIndexData(index, m_SubstateIndexData));
        }
    ...
    public class Repeat : SimpleBaseTrigger
    {
        ...
        protected override bool ForceTrigger => m_Active;
    ...
    public class Burst : SimpleBaseTrigger, IModuleReloadClip
    {
        ...
        public override bool CanStartUseItem(Use useAbility, UsableAction.UseAbilityState abilityState)
        {
            if (m_FiredCompleteCount >= m_BurstSize) {
                if (m_BurstRepeatDelay >= 0 && m_LastTriggerTime + m_BurstRepeatDelay <= TimeUtility.Time) {
                    if (m_CanStopIfInputStop && (useAbility != null && useAbility.IsUseInputTryingToStop())) {
                        return false;
                    } else {
        ...
        public override void UseItemTrigger()
        {
            m_LastTriggerTime = TimeUtility.Time;
            m_FiredBurstCount += 1;
            base.UseItemTrigger();
        }
    ...
    public class Charged : TriggerModuleAnimatorAudioStateSet
    {
        ...
        public override void StartItemUse(Use itemAbility)
        {
            ...
            // Start Charging
            m_StartChargeTime = TimeUtility.Time;
            m_IsCharging = true;
        ...
        protected virtual void ReleaseCharge()
        {
            ...
            var normalizedShotDeltaTime = Mathf.Clamp01((TimeUtility.Time - m_StartChargeTime) / m_ChargeTimeForceNormalizer);
