...
namespace Opsive.UltimateCharacterController.Items.Actions.Modules.Throwable
{
    ...
    /// </summary>
    [Serializable]
    public abstract class ThrowableProjectileModule : ThrowableActionModule, IModuleCanActivateVisibleObject, IModuleStartItemUse, IModuleItemUseComplete, IModuleStopItemUse, IModuleOnChangePerspectives
    {
    ...
    public class SpawnProjectile : ThrowableProjectileModule
    {
        ...
        public override bool ObjectIsVisible { get => CanActivateVisibleObject(); }
        ...
        protected override void InitializeInternal()
        {
            ...
            var firstPersonPerspective = (CharacterLocomotion.NetworkInfo == null || CharacterLocomotion.NetworkInfo.IsLocalPlayer() || CharacterLocomotion.NetworkInfo.IsSpectator()) ? CharacterLocomotion.FirstPersonPerspective : false;
#else
            var firstPersonPerspective = CharacterLocomotion.FirstPersonPerspective;
#endif
        ...
        protected override void UpdateRegisteredEventsInternal(bool register)
        {
            ...
            if (register) {
                ThrowableAction.OnReequipThrowableItemEvent += m_OnReequipThrowableItemAction;
            } else {
                ThrowableAction.OnReequipThrowableItemEvent -= m_OnReequipThrowableItemAction;
            }
        ...
        public void EnableObjectMeshRenderers(bool enable)
        {
            ...
            var firstPersonPerspective = CharacterLocomotion.FirstPersonPerspective;
#endif
            var renderers = firstPersonPerspective ? m_FirstPersonObjectRenderers : m_ThirdPersonObjectRenderers;
            if (renderers != null) {
