...
namespace Opsive.UltimateCharacterController.Items.Actions
{
    ...
    public abstract class CharacterItemAction : StateBehavior
    {
        ...
        public event Action<ActionModule> OnModuleAddedEvent;
        public event Action<ActionModule> OnModuleRemovedEvent;
        public event Action OnDrawGizmosEvent;
        public event Action OnDrawGizmosSelectedEvent;
        public event Action<bool> OnDrawGizmosHybridEvent;
        ...
        public INetworkCharacterInventory NetworkCharacter => m_NetworkCharacter;
        public bool FirstPersonPerspective => (m_NetworkInfo == null || m_NetworkInfo.IsLocalPlayer() || m_NetworkInfo.IsSpectator())  ? m_CharacterLocomotion.FirstPersonPerspective : false;
#else
        public bool FirstPersonPerspective =>  m_CharacterLocomotion.FirstPersonPerspective;
#endif
        ...
        {
#if ULTIMATE_CHARACTER_CONTROLLER_MULTIPLAYER
            if (m_NetworkInfo != null && !m_NetworkInfo.IsLocalPlayer() && !m_NetworkInfo.IsSpectator()) {
#endif
        ...
        public virtual void InitializeAction(bool force)
        {
            ...
            m_NetworkCharacter = m_Character.GetCachedComponent<INetworkCharacterInventory>();
#endif
        ...
        {
            OnModuleAddedEvent?.Invoke(module);
        }
        ...
        {
            OnModuleRemovedEvent?.Invoke(module);
        }
        ...
        /// <summary>
        /// Invoked update. This event can be listened to by any module.
        /// </summary>
        ...
        {
            InvokeOnModulesWithType(firstPersonPerspective, (IModuleOnChangePerspectives module, bool i1) => module.OnChangePerspectives(i1));
        }
        ...
        public virtual void OnDrawGizmos()
        {
            ...
            OnDrawGizmosHybridEvent?.Invoke(false);
        }
        ...
        public virtual void OnDrawGizmosSelected()
        {
            ...
            OnDrawGizmosHybridEvent?.Invoke(true);
        }
    }
}