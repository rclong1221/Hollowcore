...
namespace Opsive.UltimateCharacterController.Items.Actions
{
    ...
    public class UsableAction : CharacterItemAction, IUsableItem, IDamageSource
    {
        ...
        protected override void InitializeActionInternal(bool force)
        {
            ...
            m_NextAllowedUseTime = TimeUtility.Time;
        ...
        {
            if (m_WaitForUseBeforeCanStartAgain && m_UseEvent.IsWaiting) {
                if (IsDebugging) {
            ...
            if (m_WaitForUseCompleteBeforeCanStartAgain && m_UseCompleteEvent.IsWaiting) {
                if (IsDebugging) {
            ...
            if (TimeUtility.Time < m_NextAllowedUseTime) {
                if (IsDebugging) {
        ...
        {
            m_LastStartUseTime = TimeUtility.Time;
        ...
        public virtual void TriggeredUseItemAction()
        {
            ...
            m_UseEvent.CancelWaitForEvent();
            m_LastUseTime = TimeUtility.Time;
        ...
        private bool UseItemUpdateInternal(Use useItemAbility)
        {
            ...
            TryUseItem(useItemAbility, false);
            ...
            if (CanStartUseItem(useItemAbility, UseAbilityState.Update)) {
                ...
                TryUseItem(useItemAbility, true);
            } else {
                return false;
            }
        ...
        /// </summary>
        /// <param name="useItemAbility">The use item ability.</param>
        /// <param name="startItemUse">Was the item just started?</param>
        private void TryUseItem(Use useItemAbility, bool startItemUse)
        {
            ...
            if (startItemUse || CanUseItem()) {
                ...
                if (!useItemAbility.IsActive) { return; }
        ...
        public virtual void ItemUseComplete()
        {
            ...
            m_NextAllowedUseTime = TimeUtility.Time + (m_UseRate / m_CharacterLocomotion.TimeScale);
