...
namespace Opsive.UltimateCharacterController.Items.AnimatorAudioStates
{
    ...
    public abstract class AnimatorAudioStateSelector
    {
        ...
        public virtual int GetNextStateIndex()
        {
            return -1;
        }
        ...
        public virtual void SetNextStateIndex(int stateIndex) { }
        ...
        public virtual int[] GetNextStateIndexes()
        {
            return null;
        }
        ...
        public virtual void SetNextStateIndexes(int[] stateIndexes) { }
