...
namespace Opsive.UltimateCharacterController.Items.AnimatorAudioStates
{
    ...
    public class AnimatorAudioStateSet
    {
        ...
        public int GetNextStateIndex()
        {
            ...
            return m_AnimatorAudioStateSelector.GetNextStateIndex();
        }
        ...
        public void SetNextStateIndex(int stateIndex)
        {
            if (m_AnimatorAudioStateSelector == null || m_States.Length == 0) {
                return;
            }

            m_AnimatorAudioStateSelector.SetNextStateIndex(stateIndex);
        }
        ...
        public int[] GetNextStateIndexes()
        {
            if (m_AnimatorAudioStateSelector == null || m_States.Length == 0) {
                return null;
            }

            return m_AnimatorAudioStateSelector.GetNextStateIndexes();
        }
        ...
        public void SetNextStateIndexes(int[] stateIndexes)
        {
            if (m_AnimatorAudioStateSelector == null || m_States.Length == 0) {
                return;
            }

            m_AnimatorAudioStateSelector.SetNextStateIndexes(stateIndexes);
        }
