...
namespace Opsive.UltimateCharacterController.Camera
{
    ...
    public class CameraControllerHandler : MonoBehaviour
    {
        ...
        protected bool m_AllowGameplayInput;
        ...
        /// <summary>
        /// Updates the input for the camera zoom.
        /// </summary>
...
#if FIRST_PERSON_CONTROLLER && THIRD_PERSON_CONTROLLER
        /// <summary>
        /// Updates the input between a first and third person perspective.
        /// </summary>
        ...
        /// <summary>
        /// Returns the input for the camera.
        /// </summary>
        ...
        public virtual void UnregisterAbilityInputEvent(ActiveInputEvent inputEvent)
        {
