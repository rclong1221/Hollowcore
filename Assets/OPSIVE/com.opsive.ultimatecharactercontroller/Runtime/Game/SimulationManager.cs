...
namespace Opsive.UltimateCharacterController
{
    ...
    public class SimulationManager : MonoBehaviour
    {
        ...
        protected static SimulationManager Instance
        {
            get {
                if (!s_Initialized) {
                    ...
                    s_Instance = UnityEngine.Object.FindAnyObjectByType<SimulationManager>();
#else
                    s_Instance = UnityEngine.Object.FindObjectOfType<SimulationManager>();
#endif
                    if (s_Instance == null) {
        ...
        /// </summary>
        public class SmoothedCharacter : SmoothedTransform
        {
        ...
        /// </summary>
        public class SmoothedCamera : SmoothedTransform
        {
            ...
            /// <summary>
            /// Immediately set the camera's field of view.
            /// </summary>
            /// <param name="fieldOfView">The field of view of the camera.</param>
            public void SetFieldOfView(float fieldOfView)
            {
                m_Camera.fieldOfView = m_FixedFieldOfView = m_SmoothFieldOfView = fieldOfView;
            }
        }
        ...
        /// </summary>
        public class SmoothedObject : SmoothedTransform
        {
        ...
        public ResizableArray<SmoothedCharacter> Characters => m_Characters;
        public ResizableArray<SmoothedCamera> Cameras => m_Cameras;
        public ResizableArray<SmoothedObject> SmoothedObjects => m_SmoothedObjects;
        ...
        /// <param name="simulationIndex">The index of the camera that should be set.</param>
        /// <param name="fieldOfView">The field of view of the camera.</param>
        public static void SetCameraFieldOfView(int simulationIndex, float fieldOfView)
        {
            Instance.SetCameraFieldOfViewInternal(simulationIndex, fieldOfView);
        }
        ...
        /// <param name="simulationIndex">The index of the camera that should be set.</param>
        /// <param name="fieldOfView">The field of view of the camera.</param>
        private void SetCameraFieldOfViewInternal(int simulationIndex, float fieldOfView)
        {
            if (simulationIndex < 0 || simulationIndex >= m_Cameras.Count) {
                return;
            }

            m_Cameras[simulationIndex].SetFieldOfView(fieldOfView);
        }
