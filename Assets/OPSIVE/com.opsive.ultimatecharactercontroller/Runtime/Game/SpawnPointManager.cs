        ...
        private static SpawnPointManager Instance
        {
            get
            {
                if (!s_Initialized) {
                    ...
                    s_Instance = UnityEngine.Object.FindAnyObjectByType<SpawnPointManager>();
#else
                    s_Instance = UnityEngine.Object.FindObjectOfType<SpawnPointManager>();
#endif
                    if (s_Instance == null) {
                        s_Instance = new GameObject("SpawnPointManager").AddComponent<SpawnPointManager>();
                    }
                    s_Initialized = true;
                }
                return s_Instance;
