    ...
    public class LayerManager : MonoBehaviour
    {
        ...
        public static void Initialize()
        {
            if (!s_Initialized) {
                ...
                s_Instance = UnityEngine.Object.FindAnyObjectByType<LayerManager>();
#else
                s_Instance = UnityEngine.Object.FindObjectOfType<LayerManager>();
#endif
                if (s_Instance == null) {
                    s_Instance = new GameObject("LayerManager").AddComponent<LayerManager>();
                }
                s_Initialized = true;
            }
        }
