...
namespace Opsive.UltimateCharacterController.Motion
{
    ...
    public class SmoothRandom
    {
        ...
        /// </summary>
        /// <param name="speed">The speed changes how fast the change from the previous random value was.</param>
        /// <returns>A vector 3.</returns>
        public static Vector3 GetVector3(float speed)
        {
            float time = TimeUtility.Time * 0.01f * speed;
        ...
        /// <summary>
        /// Get a centered vector 3.
        /// </summary>
        /// <param name="speed">>The speed changes how fast the change from the previous random value was.</param>
        /// <returns>The centered random vector3.</returns>
        public static Vector3 GetVector3Centered(float speed)
        {
            var time1 = TimeUtility.Time * 0.01f * speed;
            var time2 = (TimeUtility.Time - 1) * 0.01f * speed;
        ...
        private class Perlin
        {
            ...
            /// Returns noise.
            /// </summary>
            /// <param name="arg">The noise argument.</param>
            ...
            /// 3D noise.
            /// </summary>
            /// <param name="x">The first dimension argument.</param>
            /// <param name="y">The second dimension argument.</param>
            /// <param name="z">The third dimension argument.</param>
            /// <returns>The 3D noise value.</returns>
        ...
        private class FractalNoise
        {
            ...
            /// </summary>
            /// <param name="inH">The power.</param>
            /// <param name="inLacunarity">The lacunarity.</param>
            /// <param name="inOctaves">The octave.</param>
            /// <param name="noise">The perlin noise.</param>
            ...
            /// <summary>
            /// Returns a hybrid multi fractal noise.
            /// </summary>
            /// <param name="x">The first dimension argument.</param>
            /// <param name="y">The second dimension argument.</param>
            /// <param name="offset">The offset.</param>
            /// <returns>The hybrid multi fractal noise value.</returns>
