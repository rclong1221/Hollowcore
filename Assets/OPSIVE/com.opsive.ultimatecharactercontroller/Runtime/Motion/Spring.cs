...
namespace Opsive.UltimateCharacterController.Motion
{
    ...
    public class Spring
    {
        ...
        protected Vector3 m_RestValue;
        protected bool m_RotationalSpring;
        ...
        protected bool m_Resting;

        // Update the spring forces with the Scheduler.
        ScheduledEventBase m_ScheduledEvent;

        [NonSerialized] public Vector3 Value { get { return m_Value; } set { m_Value = value; } }
        [NonSerialized] public Vector3 Velocity { get { return m_Velocity; } set { m_Velocity = value; } }
        [NonSerialized] public Vector3 RestValue { get { return m_RestValue; }
            set {
                m_Resting = false;
        ...
        public bool RotationalSpring { get { return m_RotationalSpring; } }
        public float VelocityFadeInCap { get { return m_VelocityFadeInCap; } }
        public float VelocityFadeInEndTime { get { return m_VelocityFadeInEndTime; } }
        public Vector3[] SoftForceFrames { get { return m_SoftForceFrames; } }
        [NonSerialized] public float TimeScale { get { return m_TimeScale; } set { m_TimeScale = value; } }
        public bool Resting { get { return m_Resting; } }
        ...
        public void Initialize(bool rotationalSpring, bool fixedUpdate)
        {
            ...
            m_VelocityFadeInEndTime = TimeUtility.Time + m_VelocityFadeInLength;
            m_Resting = false;
        ...
        protected void Tick()
        {
            if (TimeUtility.TimeScale == 0 || m_TimeScale == 0) {
                return;
            }

            // Slowly fade in the velocity at the start.
            if (m_VelocityFadeInCap != 1) {
                if (m_VelocityFadeInEndTime > TimeUtility.Time) {
                    m_VelocityFadeInCap = Mathf.Clamp01(1 - ((m_VelocityFadeInEndTime - TimeUtility.Time) / (m_VelocityFadeInLength / m_TimeScale)));
                } else {
        ...
        private void Move()
        {
            m_Value += m_TimeScale * TimeUtility.TimeScale * m_Velocity;
