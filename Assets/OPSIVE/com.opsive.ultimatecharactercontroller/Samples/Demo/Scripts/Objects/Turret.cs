...
namespace Opsive.UltimateCharacterController.Demo.Objects
{
    ...
    public class Turret : MonoBehaviour
    {
        ...
        [Tooltip("The impact damage data which contains information abou the force, damage, etc.")]
        ...
        public void Fire()
        {
            ...
            if (m_MuzzleFlash) {
                var muzzleFlash = ObjectPoolBase.Instantiate(m_MuzzleFlash, m_MuzzleFlashLocation.position, m_MuzzleFlashLocation.rotation, m_Transform).GetCachedComponent<IMuzzleFlash>();
