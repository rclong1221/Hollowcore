    ...
    public static class ObjectInspector
    {
        ...
        private static object DrawFields(object obj, bool drawNoFieldsNotice, long hashPrefix)
        {
            ...
            for (int i = 0; i < fields.Length; ++i) {
                ...
                if (tooltip != null) {
                    guiContent = new GUIContent(ObjectNames.NicifyVariableName(fields[i].Name), tooltip.tooltip);
                } else {
                    guiContent = new GUIContent(ObjectNames.NicifyVariableName(fields[i].Name));
                }
