...
#endif
        [Tooltip("Should the PlayerInput component be disabled when the UnityInputSystem component is disabled?")]
        [SerializeField] protected bool m_DisablePlayerInput = true;
