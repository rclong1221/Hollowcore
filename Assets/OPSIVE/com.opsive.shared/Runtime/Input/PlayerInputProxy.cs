...
namespace Opsive.Shared.Input
{
    ...
    public class PlayerInputProxy : MonoBehaviour, IPlayerInput
    {
        ...
        /// </summary>
        /// <param name="buttonName">The name of the button.</param>
        /// <param name="waitForDoublePressTapTimeout">Should the button down event wait for the double press timeout?</param>
        /// <returns>True if the button is pressed this frame.</returns>
        public bool GetButtonDown(string buttonName, bool waitForDoublePressTapTimeout = false)
        {
            return m_PlayerInput.GetButtonDown(buttonName, waitForDoublePressTapTimeout);
        }
