...
namespace Opsive.Shared.Audio
{
    ...
    public class AudioClipSet
    {
        ...
        [System.NonSerialized] private PlayResult m_LastPlayResult;

        /// <summary>
        /// Returns true if the Audio Clip Set has an audio clip.
        /// </summary>
        /// <returns></returns>
        ...
        protected AudioClipInfo GetAudioClipInfo(int index)
        {
