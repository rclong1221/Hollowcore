...
namespace Opsive.UltimateCharacterController.AddOns.Agility.Editor.Inspectors.Character.Abilities
{
	...
	public class LedgeStrafeDrawer : AbilityDrawer
	{
		...
		{
			FieldInspectorView.AddFields(unityObject, target, Opsive.Shared.Utility.MemberVisibility.Public, container, onChangeEvent, null, onValidateChange, false, null, LabelControl.WidthAdjustment.UnityDefault);
		}
